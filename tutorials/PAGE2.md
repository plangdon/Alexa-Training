...
1. Click <a href="https://console.aws.amazon.com/lambda/home" target="_blank">Lambda</a> and then **Create a Lambda function**  Do not select the default **Blank** blueprint.
...
1. Paste in the source code from /labs/lab1/index.js
